...
public class ClassSet implements Set {
	...
	public int size() {
		// throw new
		// java.lang.UnsupportedOperationException("Method size() not yet implemented.");
		return vector.size();
	}

	public boolean isEmpty() {
		// throw new
		// java.lang.UnsupportedOperationException("Method isEmpty() not yet implemented.");
		return vector.isEmpty();
	}

	public boolean contains(Object o) {
		// throw new
		// java.lang.UnsupportedOperationException("Method contains() not yet implemented.");
	...
	public Iterator iterator() {
		// throw new
		// java.lang.UnsupportedOperationException("Method iterator() not yet implemented.");
		return vector.iterator();
	}

	public Object[] toArray() {
		// throw new
		// java.lang.UnsupportedOperationException("Method toArray() not yet implemented.");
	...
	public boolean add(Object o) {
		// throw new
		// java.lang.UnsupportedOperationException("Method add() not yet implemented.");
		if (!this.contains(o))
			return vector.add(o);
		else
			return true;
	...
	public boolean remove(Object o) {
		// throw new
		// java.lang.UnsupportedOperationException("Method remove() not yet implemented.");
		return vector.remove(o);
		/*
		 * Iterator i = this.iterator(); Object del = null; while(i.hasNext()){
		 * Object ob = i.next(); if(ob.toString().compareTo(o.toString()) == 0){
		 * del = ob; } } if(del != null) return vector.remove(del); else return
		 * false;
		 */
	}
	...
	public boolean containsAll(Collection c) {
		// throw new
		// java.lang.UnsupportedOperationException("Method containsAll() not yet implemented.");
		return vector.containsAll(c);
	}

	public boolean addAll(Collection c) {
		// throw new
		// java.lang.UnsupportedOperationException("Method addAll() not yet implemented.");
		return vector.addAll(c);
	}

	public boolean retainAll(Collection c) {
		// throw new
		// java.lang.UnsupportedOperationException("Method retainAll() not yet implemented.");
		return vector.retainAll(c);
	}

	public boolean removeAll(Collection c) {
		// throw new
		// java.lang.UnsupportedOperationException("Method removeAll() not yet implemented.");
		return vector.removeAll(c);
	}

	public void clear() {
		// throw new
		// java.lang.UnsupportedOperationException("Method clear() not yet implemented.");
		vector.clear();
	}

	public boolean equals(Object o) {
		// throw new
		// java.lang.UnsupportedOperationException("Method equals() not yet implemented.");
	...
	/*
	 * public ClassSet sort(){ ClassSet ret = new ClassSet;
	 * 
	 * }
	 */
	...
	public ClassSet intersect(ClassSet s) {
		...
		//recorrer el arreglo si hay más elementos
		while (i.hasNext()) {
			Object o = i.next();
			//evaluar objetos
	...
	public ClassSet closure(DepSet deps) {
		...
		while (!cl.equiv(cl2)) { // Si existe una dependencia que analizar
			...
			while (i.hasNext()) {// Iteramos sobre la dependecias restantes
				...
				if (cl.includes(d.giveX())) { // El lado izquierdo de la
												// dependencia, esta incluida
												//
					// ClassSet tmp = cl.copy();
					cl.union(d.giveY()); // Agrego el atributo a la clausura de
											// la dependencia
					// cl = (ClassSet)
				}
			}
	...
	public ClassSet bruteKeys(DepSet deps) {
		...
		while (i.hasNext()) {
			ClassSet n = (ClassSet) i.next();
			//funciones que llevan información asociada relativa al momento en que son invocadas
	...
	public boolean depLoss(DepSet dfs, ClassSet pr) {
		//DepSet ret = new DepSet();
		boolean hayPerdida=true;
...
public boolean verifico(ClassSet keyCandidata){
	return (this.includes(keyCandidata));
	//return false;
}
...
//	}
	...
	public String toSqlTabla(ClassSet depfun) {
		String s = "";
		...
		// return s;
		s += " PRIMARY KEY ( ";
		for (int k = 0; k < depfun.size(); k++) {
			Object o = depfun.elementAt(k);
			s += o.toString();
			if (k < (depfun.size() - 1))
				s = s + ",";
		}
	...
	public ClassSet llavesCandidatas(DepSet deps) {
		ClassSet sk = this.bruteKeys(deps);
		ClassSet cand = new ClassSet();
		Iterator i = sk.iterator();
		boolean flag;
		while (i.hasNext()) {
			ClassSet a = (ClassSet) i.next();
			ClassSet c = a.reduction();
			Iterator j = c.iterator();
			flag = true;
			while (j.hasNext()) {
				ClassSet d = ((ClassSet) j.next());
